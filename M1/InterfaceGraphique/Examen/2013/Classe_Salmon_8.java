...
public class Classe_Salmon_8 extends JFrame implements ActionListener, MouseListener, MouseMotionListener{
	...
	public void mouseDragged(MouseEvent e) {
		...
		if((e.getWhen() - t < 100) && (50 < Point2D.distance(x, y, e.getX(), e.getY()))){
